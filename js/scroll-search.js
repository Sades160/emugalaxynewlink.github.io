    ...
    $('#search').keyup(function() {
        ...
        $.each(game_data, function(key, value) {
            if (value.name.search(expression) != -1) {
                $('#result').append('<li><a href="https://emugalaxy.dev/' + value.url + '" class="list-group-item"><img src="https://emugalaxy-storage1.github.io/thumbs/'+ value.image +'" data-loaded="true" style="width:40%;"><div class="list-group-text"> ' + value.name + '</div><span class="emu-sys">' + value.sys + '</span></a></li>');
            }
        });
    });
